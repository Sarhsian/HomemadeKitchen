...
namespace CasualShop
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<EFDBContext>(options => options.UseSqlServer(connection, b => b.MigrationsAssembly("HomemadeKitchen.DAL")));
            //add service for contextUser
            ...
            services.AddTransient<IOrderInfoRepository, EFOrderInfoRepository>();
